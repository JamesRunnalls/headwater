        ...
        <div className="about-dialog-body">
          ...
          <ul className="about-sources">
            {SOURCES.map(({ key, href }) => (
              <li key={key}>
                <a href={href} target="_blank" rel="noopener noreferrer" className="about-source-link">
                  {t[key]}
                </a>
              </li>
            ))}
          ...
          <div className="about-github">
            <a
              href="https://github.com/JamesRunnalls/headwater"
              target="_blank"
              rel="noopener noreferrer"
              className="about-github-link"
            >
              <svg className="about-github-icon" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true">
