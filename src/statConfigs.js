...
export const STAT_FIELDS = {
  ...
  glacier_runoff:          { icon: "discharge",     tKey: "glacierRunoff",    fallback: "Modelled runoff",   format: (v) => fmt(v, 3), unit: "m³/s" },
  ...
  pct_next_5d:             { icon: "discharge",     tKey: "pctNext5d",        fallback: "Next 5 days",       format: (v) => fmt(v, 1), unit: "%" },
};
